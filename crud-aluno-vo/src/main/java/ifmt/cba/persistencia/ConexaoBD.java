...
public class ConexaoBD {
    ...
    private ConexaoBD() throws PersistenciaException{
        try{
            ...
            throw new PersistenciaException("Erro ao conectrar o banco de dados - "+ex.toString());
    ...
    public void desconectar() throws PersistenciaException {
        try {
            ...
            throw new PersistenciaException("Erro ao desconecetar o banco de dados - "+ex.toString());
        }
    }
}
